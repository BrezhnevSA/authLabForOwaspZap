...
var API_URL = "http://express-form:3000";
...
function login(helper) {
    ...
    var message=newMessage(HttpRequestHeader.POST, API_URL + "/login", "application/x-www-form-urlencoded", body, null);
    helper.getHttpSender().sendAndReceive(message, false);
    if (!requireStatus(message,[302])) return null;
